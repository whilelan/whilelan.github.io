(function($) {
    ...
    // Settings Object
    var IDXSETTINGS = {
        'homepage_chat_room_limit': parseInt('6')
    }    
    ...
    function search_chatroom(){
        ...
        $.ajax({
            url: "https://www.moechat.cc/ajax/ajax-chatroom-search",
            data: {
                q: q,
                created_by: created_by,
                order_by: order_by,
                csrftoken: 'wsZP4942DQSwlc+xdBUNhJj3Ne+5EPUChFiVqLB8ogY='
            },
            type: "POST",
            beforeSend: function() {
    ...
    $(document).ready(function() {
        ...
        $(".update-settings").on('click', function(e) {
            ...
            $('.settings-error').hide();
            $.ajax({
                url: "https://www.moechat.cc/ajax/update-settings",
                data: data,
                type: "POST",
                dataType: 'json',
                contentType: false,
        ...
        $(document).on("click", '#load-more', function() {
            ...
            $.ajax({
                url: "https://www.moechat.cc/ajax/ajax-chatroom-load-more",
                data: {
